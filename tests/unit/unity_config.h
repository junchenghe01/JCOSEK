...
static FILE* unity_output_file = NULL;
...
#define UNITY_OUTPUT_CHAR(a)    do { if (unity_output_file) fputc(a, unity_output_file); putchar(a); } while(0)
#define UNITY_OUTPUT_FLUSH()    do { if (unity_output_file) fflush(unity_output_file); fflush(stdout); } while(0)
#define UNITY_OUTPUT_START()    do { unity_output_file = fopen("test_output.txt", "w"); } while(0)
#define UNITY_OUTPUT_COMPLETE() do { if (unity_output_file) fclose(unity_output_file); } while(0) 
